...
# вообще не вдупляю, почему в DBeaver все базы идут вразнос и код, который пишем на уроке, выдаёт с ошибкой! Извините за мой французский. Этот курс для меня идёт с большим трудом, поэтому даже думать не могу о 'теме курсового проекта'
